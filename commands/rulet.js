...
module.exports.run = async (bot, message, args) => {
  ...
  .setDescription(`Bir miktar berlirlemen gerek! \`Örnek: ${dens.prefix}roulet <renk> <miktar>\``);
  ...
  if (rulett !== null && timeout - (Date.now() - rulett) > 0) {
    ...
    db.set(`rulet_${message.guild.id}_${user.id}`, Date.now())
        ...
        .setColor("#FFFFFF")
        .setFooter(dens.altYazi)
        .setDescription(`**Heyyy! Yeşil tuttu \`${money}\` ${dens.paraBirimi} kazandın**\n\nÇarpanı: 15x`);
        ...
        .setColor("#FFFFFF")
        .setFooter(dens.altYazi)
        .setDescription(`**Heyyy! Kırmızı tuttu \`${money}\` ${dens.paraBirimi} kazandın**\n\nÇarpanı: 1.5x`);
        ...
        .setColor("#FFFFFF")
        .setFooter(dens.altYazi)
        .setDescription(`**Heyyy! Siyah tuttu \`${money}\` ${dens.paraBirimi} kazandın**\n\nÇarpanı: 2x`);
        ...
        .setColor("#FFFFFF")
        .setFooter(dens.altYazi)
        .setDescription(`**Malesefki  \`${money}\` ${dens.paraBirimi} kaybettin şansını birdaha dene**`);
